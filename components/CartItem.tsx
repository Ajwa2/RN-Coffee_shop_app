...
const CartItem : React.FC<CartItemProps> = ({
    id, name, imagelink_square, special_ingredient,
    roasted, prices, type,
                        ...
                        <View style={styles.SizeBox}>
                            <Text
                                style={[styles.SizeText, {
                                    fontSize:type == 'Bean' ? FONTSIZE.size_10 : FONTSIZE.size_14,},]}>
                                {data.size}
                            </Text>
                        </View>
        ...
        <LinearGradient
            ...
            <View style={styles.CartItemSingleInfoContainer}>
                ...
                <View style={styles.CartItemSingleSizeValueContainer}>
                    <View style={styles.SizeBox}>
                        <Text style={[styles.SizeText,{fontSize:
